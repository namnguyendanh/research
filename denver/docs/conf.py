...
html_logo = '_static/denver_core.png'
html_theme_options = {
    'logo_only': True
}

html_favicon = '_static/denver_core.ico'

# -- Options for HTMLHelp output ------------------------------------------

# Output file base name for HTML help builder.
htmlhelp_basename = 'Denverdoc'
...
latex_documents = [
    (master_doc, 'Denver.tex', 'Denver Documentation',
     'phucpx', 'manual'),
]
...
man_pages = [
    (master_doc, 'denver', 'Denver Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Denver', 'Denver Documentation',
     author, 'Denver', 'One line description of project.',
     'phucpx'),
]
